...
vector<vector<pair<int,int> > > shorten_branches(vector<vector<pair<int,int> > > & branches,vector<double> &x,vector<double> &y,vector<double> &z)//,vector<double> &distancematrix)
{
