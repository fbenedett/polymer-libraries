...
void write_CM(long start, long end, long num_frames, long num_atoms, double epsilon, double *data, const string& add_name);
...
void write_CM(long start, long end, long num_frames, long num_atoms, double epsilon, double *data, const string& add_name=string()){
